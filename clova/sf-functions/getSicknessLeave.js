...
function getSicknessLeave(){
  ...
  xhr.open("GET", "https://sandbox.api.sap.com/successfactors/odata/v2/EmpTimeAccountBalance?$filter=userId eq 'sfadmin' and timeAccountType eq 'TAT_SICK_REC'", false);
  ...
  return data.d.results[0].balance;

}
module.exports = getSicknessLeave;
