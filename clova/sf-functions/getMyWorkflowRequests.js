...
function getMyWorkflowRequests(){
  ...
  xhr.open("GET", "https://sandbox.api.sap.com/successfactors/odata/v2/Todo?$filter=categoryId eq '14'", false);
...
module.exports = getMyWorkflowRequests;
